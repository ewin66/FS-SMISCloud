...
namespace FreeSun.FS_SMISCloud.Server.CloudApi.DAL
{
    ...
    public partial class T_THEMES_VIBRATION_DECK_VIBRATION
    {
        public int ID { get; set; }
        public Nullable<int> SENSOR_ID { get; set; }
        public Nullable<int> SAFETY_FACTOR_TYPE_ID { get; set; }
        public Nullable<decimal> DECK_VIBRATION_PHYSICAL_QUANTITY_VALUE { get; set; }
        public Nullable<decimal> DECK_VIBRATION_VALUE { get; set; }
