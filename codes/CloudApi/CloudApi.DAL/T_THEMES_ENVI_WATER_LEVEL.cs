...
namespace FreeSun.FS_SMISCloud.Server.CloudApi.DAL
{
    ...
    public partial class T_THEMES_ENVI_WATER_LEVEL
    {
        ...
        public Nullable<decimal> WATER_LEVEL_VALUE { get; set; }
        public Nullable<decimal> WATER_LEVEL_CUMULATIVEVALUE { get; set; }
        public Nullable<byte> WATER_LEVEL_SCORE { get; set; }
