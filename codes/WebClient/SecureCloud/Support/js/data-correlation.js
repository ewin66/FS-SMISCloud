/**
 * ---------------------------------------------------------------------------------
 * <copyright file="data-correlation.js" company="江苏飞尚安全监测咨询有限公司">
 * Copyright (C) 2015 飞尚科技
 * 版权所有。
 * </copyright>
 * ---------------------------------------------------------------------------------
 * <summary>
 * 文件功能描述："数据关联"子菜单页面js文件
 *
 * 创建标识：
 *
...
$(function() {
    ...
    $('#factorList1').change(function() { //根据监测因素变换测点
        ...
        getCorrelationFactor(valueNumber[0]);
...
$('a.box-collapse').click(function () {
    var $target = $(this).parent().parent().next('#dataList');
...
//获得关联监测因素
function getCorrelationFactor(factorId) {
