<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThreeChar.aspx.cs" Inherits="SecureCloud.MonitorProject.ThreeChar" %>
...
<body>
    <form id="Comm_Factor3" runat="server">
        <div>
            <div class="box">
                    ...
                    <div class="row-fluid">
                        <div class="form-horizontal">
                            <div class="control-group">
                                <div id="monitorDisplay" style="display: none">
                                    <b>设备类型：</b>
                                    <select id="monitorList" name='monitorList' class="span2" title="请选择" data-size="10">
                                    </select>
                                </div>
                                <b>设备位置：</b>
                            ...
                            <div class="box-content span12" id="alldiv">
                                ...
                                <div>
                                    <div class="span8">
                                        <div class="box" id="chart_y" style="height: 360px; display: none;"></div>
                                ...
                                <div>
                                    <div class="span8">
                                        <div class="box" id="chart_z" style="height: 360px; display: none;"></div>
                                        <div id="z_error" style="display: none;"></div>
                                    </div>
                                    <div class="span3">
                                        <div class="box" id="ZwarnBox" style="display: none">
                                            <table id="ZwarnTable" class="warnTable">
                                                <tr class="heightTr">
                                                    <th class="headTh">位置:</th>
                                                    <th id="ZsensorLocation" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">历史告警:</th>
                                                    <th class="Th">
                                                        <a id="ZsensorLink" style="cursor: pointer">查看</a>
                                                    </th>
                                                </tr>

                                                <tr class="heightTr">
                                                    <th class="headTh">最大值:</th>
                                                    <th id="ZmaxValue" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">最小值:</th>
                                                    <th id="ZminValue" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">一级阈值:</th>
                                                    <th id="ZfirstThreshold" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">二级阈值:</th>
                                                    <th id="ZsecondThreshold" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">三级阈值:</th>
                                                    <th id="ZthirdThreshold" class="Th"></th>
                                                </tr>
                                                <tr class="heightTr">
                                                    <th class="headTh">四级阈值:</th>
                                                    <th id="ZfourthThreshold" class="Th"></th>
                                                </tr>
    ...
    <script src="../commFactor/js/Comm_Factor3.js"></script>
