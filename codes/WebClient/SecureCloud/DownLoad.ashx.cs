...
namespace SecureCloud
{
    ...
    public class DownLoad : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string fileName = context.Server.HtmlDecode(context.Request.QueryString["fileName"]);

            //string fileName="D:\\report\\啊1+2.xls";
            var speed = 0;
            Int32.TryParse(ConfigurationManager.AppSettings["DownloadSpeed"], out speed);

            DownloadFile(context, fileName, speed * 1000);
        }
        ...
        public static bool DownloadFile(HttpContext httpContext, string filePath, long speed, string downloadAsFileName=null)
        {
            ...
            try
            {
                ...
                string fileName = downloadAsFileName??Path.GetFileName(filePath);
                ...
                try
                {
                    ...
                    httpContext.Response.AddHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(fileName, Encoding.UTF8).Replace("+", "%20").Replace("%2b","+"));
