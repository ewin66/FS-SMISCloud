                      ...
                      $.ajax({
                          ...
                          success: function (data) {
                              ...
                              if (dataHotSpot[j].factorId == 26) {
                                  if (data.ValueTemp == null) {
                                      title += "<br />温度： 无";
                                  } else {
                                      title += '<br />温度：' + data.ValueTemp.toFixed(2) + " " + data.Unit;
                                  }
                                  ...
                                  if (data.Values == null) {
                                      ...
                                      title += '<br />沉降：' + data.Values + " " + data.Unit;
                                  }
                                  title += '<br/><div style="word-break: keep-all;white-space:nowrap;">采集时间：' + time + '</div>';
                                  ...
                                  if (data.ValuesX == null) {
                                      ...
                                      title += '<br />支座位移：' + data.ValuesX.toFixed(2) + " " + data.Unit;
                                  }
                                  title += '<br/><div style="word-break: keep-all;white-space:nowrap;">采集时间：' + time + '</div>';
                                  ...
                                  title += "</tr><tr><th style='word-break: keep-all;white-space:nowrap;'>主应力(MPa)</th><td colspan='" +
