$(function () {
    ...
    setCookie('nowStructId', nowstructId,null)
    setTimeout(function () {
        ...
        success: function (data) {
            ...
            if (warnings.length == 0) {
                ...
                for (var i = 0; i < warnings.length; i++) {
                    ...
                    waringSB.append('<a href="/DataWarningTest.aspx?structId=' + structId + '"><span class="label label-important label-mini">处理<i class="icon-share-alt"></i></span></a>');
