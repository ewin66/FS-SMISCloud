...
namespace FS.SMIS_Cloud.NGDAC.Model.Sensors
{
    ...
    public class VibratingWireData : BasicSensorData
    {
        ...
        {
            get { return new [] { this.Frequency, this.Temperature}; }
        }
        ...
        public override double[] PhyValues
        {
            get
            {
                if (Math.Abs(this.ColPhy - this.PhysicalQuantity) > 0.00000001)
                    return new[] {this.ColPhy, this.PhysicalQuantity};
                return new[] { this.PhysicalQuantity };
            }
        }

        public override double[] CollectPhyValues
        {
            get { return new[] { this.ColPhy }; }
        }
