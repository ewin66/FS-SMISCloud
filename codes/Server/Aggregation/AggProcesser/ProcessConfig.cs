    ...
    public abstract class ProcessConfig
    {
        ...
        public static Dictionary<string, Type> FromXML(string fileName)
        {
            ...
            try
            {
                ...
                var nodes = doc.Root.Element("Processes").Elements();
            ...
            catch (Exception e)
            {
                ...
                Log.Warn("AggProcess.xml parse error", e);
            }
            return ret;
        }
    }
