...
namespace FS.SMIS_Cloud.DAC.Model.Sensors
{
    ...
    public class Gps3dData : BasicSensorData
    {
        public Gps3dData(double orx, double ory, double orz,double cx,double cy,double cz)
        {
            ...
            this._themsValues = new List<double?>(new double?[] { ChangeX, ChangeY, ChangeHeight });
        ...
        public override double[] RawValues
        {
            get
            {
                return new [] { CoordX, CoordY, CoordHeight };
            }
        }

        public override double[] PhyValues
        {
            get { return new[] {ChangeX, ChangeY, ChangeHeight}; }
        }

        public override double[] CollectPhyValues
        {
            get { return new[] { CoordX, CoordY, CoordHeight }; }
        }
