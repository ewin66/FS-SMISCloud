...
namespace ReportGeneratorService.DataModule
{
    ...
    public partial class T_THEMES_STRESS_STRAIN_PORE_WATER_PRESSURE
    {
        ...
        public Nullable<decimal> PORE_WATER_PRESSURE_VALUE { get; set; }
        public Nullable<byte> PORE_WATER_PRESSURE_SCORE { get; set; }
        ...
        public Nullable<decimal> PORE_WATER_PRESSURE_VALUE_CUMULATIVEVALUE { get; set; }
