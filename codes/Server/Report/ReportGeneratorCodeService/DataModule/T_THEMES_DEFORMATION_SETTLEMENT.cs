...
namespace ReportGeneratorService.DataModule
{
    ...
    public partial class T_THEMES_DEFORMATION_SETTLEMENT
    {
        ...
        public Nullable<decimal> SETTLEMENT_VALUE { get; set; }
        public Nullable<byte> SETTLEMENT_SCORE { get; set; }
        ...
        public Nullable<decimal> Press_Original { get; set; }
        public Nullable<decimal> SETTLEMENT_VALUE_Original { get; set; }
