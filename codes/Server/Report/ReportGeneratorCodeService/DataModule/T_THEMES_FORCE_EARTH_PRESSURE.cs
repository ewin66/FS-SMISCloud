...
namespace ReportGeneratorService.DataModule
{
    ...
    public partial class T_THEMES_FORCE_EARTH_PRESSURE
    {
        ...
        public Nullable<decimal> EARTH_PRESSURE_VALUE { get; set; }
        public Nullable<byte> EARTH_PRESSURE_SCORE { get; set; }
