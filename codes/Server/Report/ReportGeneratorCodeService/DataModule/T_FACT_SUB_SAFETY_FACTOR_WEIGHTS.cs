...
namespace ReportGeneratorService.DataModule
{
    ...
    public partial class T_FACT_SUB_SAFETY_FACTOR_WEIGHTS
    {
        public int SUB_SAFETY_FACTOR_WEIGHTS_ID { get; set; }
        public Nullable<int> SAFETY_FACTOR_TYPE_ID { get; set; }
        public Nullable<byte> SUB_SAFETY_FACTOR_WEIGHTS { get; set; }
