...
namespace ReportGeneratorService.DataModule
{
    ...
    public partial class T_THEMES_DEFORMATION_CRACK
    {
        public int ID { get; set; }
        public Nullable<int> SENSOR_ID { get; set; }
        public Nullable<int> SAFETY_FACTOR_TYPE_ID { get; set; }
        public Nullable<decimal> CRACK_PHYSICAL_QUANTITY_VALUE { get; set; }
        public Nullable<decimal> CRACK_VALUE { get; set; }
