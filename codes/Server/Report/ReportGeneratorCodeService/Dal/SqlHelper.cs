...
namespace ReportGeneratorService.Dal
{
    public  abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionString =
            ConfigurationManager.ConnectionStrings["SecureCloud"].ConnectionString;
        ...
        /// <summary>
        /// CreateNewFile a SqlCommand that returns a resultset against the database specified in the connection string 
        ...
        /// <summary>
        /// CreateNewFile a SqlCommand that returns the first column of the first record against the database specified in the connection string 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// CreateNewFile a SqlCommand that returns the first column of the first record against an existing database connection 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
