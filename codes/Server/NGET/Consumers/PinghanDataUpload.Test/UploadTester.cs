namespace DataUpload.Test
{
    ...
    using FS.SMIS_Cloud.NGET.PinghanDataUpload;
    ...
    internal class UploadTester
    {
        ...
        public void TestUpolad()
        {
            ...
            uploader.ProcessResult(this.CreateDACResult());
        }

        private List<SensorAcqResult> CreateDACResult()
        {
            var nullData = new SensorAcqResult
            {
                ErrorCode = 103,
                Sensor = new Sensor {SensorID = 2115, ProductId = 145, Name = "test1"},
                Data = new SensorData(new[] { 0.1 }, new[] { 0.1 }, new[] { 0.1 })
            };
            ...
            rslt.Add(
                new SensorAcqResult
                {
                    ...
                    Data = new SensorData(new[] { 0.2 }, new[] { 0.2 }, new[] { 0.2 })
                });
            rslt.Add(
                new SensorAcqResult
                {
